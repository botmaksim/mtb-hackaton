                ...
                <div className="flex justify-between items-start w-full px-4">
                    ...
                    <div className="flex flex-col items-center pointer-events-auto">
                        ...
                        <div className="mt-2 bg-black/40 backdrop-blur-md px-4 py-1 rounded-full border border-emerald-500/30 flex items-center gap-2">
                            ...
                            <span className="text-xs font-mono font-bold text-emerald-400">+1.2k/с</span>
                        </div>
                    </div>
                ...
                <div className="max-w-lg mx-auto w-full bg-slate-900/90 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl border border-white/10 p-2 pointer-events-auto flex justify-around items-center">
                    ...
                    <div className="relative -top-5">
                        <div className="relative">
                            <button 
                                className="w-18 h-18 bg-slate-700 rounded-3xl flex items-center justify-center text-white/30 border-4 border-slate-900 pointer-events-none"
                            >
                                <LayoutGrid size={32} />
                            </button>
                            <div className="absolute -top-2 left-1/2 -translate-x-1/2 bg-red-500 text-[8px] px-2 py-0.5 rounded-full font-bold uppercase whitespace-nowrap border border-slate-900">
                                Скоро
                            </div>
                        </div>
                    </div>
