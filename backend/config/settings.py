...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware', # Отключаем CSRF для API на хакатоне
...
CORS_ALLOW_ALL_ORIGINS = True # Разрешаем все origin, чтобы избежать проблем с Docker и разными IP
